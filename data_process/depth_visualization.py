...
#size = (1280, 720)
frame_rate = 30
dir1 = "/home/data/jinyoung/Server/result_depth/"
#dir2 = "/home/data/jinyoung/Server/accident_data_saliency2/"
video_list = glob.glob('/home/data/jinyoung/Server/result_depth/*')
video_list.sort()
...
for video_name in video_list:
    ...
    saliency_list = glob.glob(dir1 + name + '/*.jpeg') # 480 X 360?
    ...
    print(new_videoname)
    out = cv2.VideoWriter('./result_depth_true/%s_demo.avi'%name,cv2.VideoWriter_fourcc(*'DIVX'), frame_rate, size)
