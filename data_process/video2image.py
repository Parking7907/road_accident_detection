...
for i in vid_list:
    ...
    out_folder_name = out_root + folder_name
    print(vid_name, out_folder_name)
    ...
    command = ("ffmpeg -ss 00:00:00 -t 60 -i {0} -r 30 -an -y  -qscale:v 2 -f image2 {1}/%06d.jpg".format(i,out_folder_name)) # -s 224x224
    output = subprocess.call(command, shell=True, stdout=None)
