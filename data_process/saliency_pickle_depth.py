...
dir1 = "/home/data/jinyoung/Server/mask_depth"
dir2 = "/home/data/jinyoung/Server/mask_depth"
source = '/home/data/jinyoung/Server/CADP_Frames'
true_output = '/home/data/jinyoung/Server/True_Frames_Depth'
false_output = '/home/data/jinyoung/Server/False_Frames_Depth'
for i in label['Video_Name']:
    ...
    file_list.sort()
    saliency_list = glob(dir1 + "/%06d"%i + '/*.jpeg') # 480 X 360?
    ...
    for j, filename in enumerate(file_list):
        if j>= false_st and j < false_en:
            ...
            img1 = img * dst
            #pdb.set_trace()
            os.makedirs('./frame_depth/%06d'%i, exist_ok=True)
            cv2.imwrite("./frame_depth/%06d/%06d.jpg"%(i,j), img1)
    ...
    image_list = glob("./frame_depth/%06d/*.jpg"%(i))
    image_list.sort()
    if length > 61:
        length = 61
    if false_length > 61:
