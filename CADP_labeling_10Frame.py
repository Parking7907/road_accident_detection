...
for i in label['Video_Name']:
    ...
    print("False Labeling :", false_frame, str(false_en), "~", str(false_en+20+10*false_frame))
    false_img_list = file_list[false_en:false_en+20+10*false_frame]
    false_start = 0
    for q in range(false_frame):
        ...
        #print(false_start, false_start+30)
